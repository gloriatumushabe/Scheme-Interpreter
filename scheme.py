...
def eval_all(expressions, env):
    ...
    environment ENV and return the value of the lagst."""
    # BEGIN PROBLEM 8
    if not expressions:
        return None
...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(target):
        ...
        func = LambdaProcedure(formals, expressions.second, env)
    ...
    # BEGIN PROBLEM 14
            ...
            if expressions == nil:
                ...
                if expressions1 == nil:
                    ...
                    return eval_all(expressions1, env)
        expressions = expressions.second
...
def make_let_frame(bindings, env):
    ...
    check_formals(a)
    return env.make_child_frame(a, vals)
    # END PROBLEM 15
...
def do_mu_form(expressions, env):
    ...
    check_formals(formals)
    # BEGIN PROBLEM 16
    content = expressions.second
    return MuProcedure(formals, content)
    # END PROBLEM 16
